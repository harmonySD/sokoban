...
- Interface graphique : La vue du jeu à gauche, le panel des objets à droite, le boutton finish
    ...
    - Une grille 2 * 4 ( Perso - Mur / Carton V - Objectif V / R - R / B - B / Erase - Clear )
...
public class CreateVue extends JFrame implements MouseListener{
    ...
    public void init() {
        ...
        for(int i = 1; i < this.board.getBoard().getHeight() - 1; i++) {
            for(int j = 1; j < this.board.getBoard().getLength() - 1; j++) {
        ...
        finish.setBackground(Color.WHITE); text.setBackground(Color.WHITE);
        ...
        clear.addMouseListener(this); finish.addMouseListener(this);
        ...
        right.add(finish); right.add(text);
        ...
        this.clear = clear; this.finish = finish; this.text = text;
    ...
    public void mouseClicked(MouseEvent arg0){
        ...
        // Si click sur bouton terminé
            ...
            if(!this.isItFinish()) {
                text.setText("Niveau non conforme");
                ...
                if(arg0.getSource() == this.board.getCase(i, j) && selected != 0) {
                    switch(selected) {
                        ...
                        case 8: // Placer un objectif vert
                            ...
                            selected = 0;
                            break;
                        case -1: // Surpprimer le contenu de la case
    ...
    public boolean isItFinish() {
        ...
        // Et s'il y a au moins un duo box / objectif => TRUE
        if(chara == 1 && (redB == redG) && (greenB == greenG) && (blueB == blueG) && (redB + blueB + greenB > 0)) { return true; }
        // Sinon FALSE
        return false;
    }
